...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n-----归并排序-----");
        int[] raw = new int[]{10, 9, 8, 7, 5, 6, 4, 3, 2, 1};
        System.out.println(GsonUtil.array2Json(Arrays.asList(SortUtils.mergeSort(raw))));
        System.out.println(GsonUtil.array2Json(Arrays.asList(raw)));
    ...
    private static void sort(Method method, int[] raw) {
        try {
            int[] result = (int[]) method.invoke(clazz, raw);
